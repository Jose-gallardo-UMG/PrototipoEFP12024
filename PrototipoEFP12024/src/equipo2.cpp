...
equipo2::equipo2(string id, string nom, string ide)
{
    this->id = id;
    this->nom = nom;
    this->ide = ide;
...
string equipo2::setid(string id)
{
    this->id = id;
    return id;
}

string equipo2::getid()
{
    return id;
}

string equipo2::setnom(string nom)
{
    this->nom = nom;
    return nom;
}

string equipo2::getnom()
{
    return nom;
}

string equipo2::setide(string ide)
{
    this->ide = ide;
    return ide;
}

string equipo2::getide()
{
    return ide;
}
